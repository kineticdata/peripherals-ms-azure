...
XML
    ...
    begin
      resp = resource["#{subscription_id}/services/hostedservices/#{vm_name}/deployments/#{deployment_name}/roleinstances/#{role_name}/Operations"].post restart_xml
    rescue Exception => e
      raise e.inspect
    end
    puts resp
